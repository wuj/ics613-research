...
| Shea Stevens | \[Fill in\] | Database administration | Front end system design |
| Matt Ong | \[Fill in\] | \[Fill in\] | \[Fill in\] |
| Kim Cates | \[Fill in\] | \[Fill in\] | \[Fill in\] |
| Jeff Wu | Team Member | Set up and maintain the Docker environment for PostgreSQL, Make \+ makefile for easy local builds, and Github Actions for linting (Ruff, ESLint \+ typescript-eslint) to run on each PR | Write Typescript to implement front end functionality and Python as needed |
...
* **Scope decisions:** \[fill in\]  
* **Scheduling decisions:** \[fill in\]  
...
| Cross-Team Requirements Review Packet | June 15, 2026 | \[Fill in\] |  |
...
| Manual Test Cases / QA Packet | July 14, 2026 | \[Fill in\] |  |
